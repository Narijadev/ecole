...
<div class="container">
  ...
  <div class="row col-lg-12">
    <div class="link d-flex justify-content-center">{{ $users->links() }}</div>
</div>  
<!--delete à cocher-->
    ...
    <tbody>
       @foreach ($users as $user)
         <tr>  
            ...
            <td><a href ="{{ URL::action('ParentController@destroy', $user->id) }}"class="btn btn-danger"  onclick="return confirm('Voulez-vous supprimer {{ $user->firstname }}?');">supprimer</a></td>
